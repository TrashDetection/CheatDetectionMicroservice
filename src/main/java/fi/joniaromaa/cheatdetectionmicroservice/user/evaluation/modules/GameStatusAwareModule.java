...
import fi.joniaromaa.minecrafthook.common.game.entity.attribute.IAttributeInstance;
import fi.joniaromaa.minecrafthook.common.game.entity.attribute.IAttributeMap;
...
import fi.joniaromaa.minecrafthook.common.network.incoming.IPlayerAbilitiesIncomingPacket;
...
import fi.joniaromaa.minecrafthook.common.network.outgoing.IAnimationOutgoingPacket;
import fi.joniaromaa.minecrafthook.common.network.outgoing.IBulkChunkOutgoingPacket;
import fi.joniaromaa.minecrafthook.common.network.outgoing.ICameraOutgoingPacket;
import fi.joniaromaa.minecrafthook.common.network.outgoing.IChangeGameStateOutgoingPacket;
import fi.joniaromaa.minecrafthook.common.network.outgoing.IChunkOutgoingPacket;
import fi.joniaromaa.minecrafthook.common.network.outgoing.IEntityAttachOutgoingPacket;
import fi.joniaromaa.minecrafthook.common.network.outgoing.IEntityPropertiesOutgoingPacket;
import fi.joniaromaa.minecrafthook.common.network.outgoing.IJoinOutgoingPacket;
import fi.joniaromaa.minecrafthook.common.network.outgoing.IPlayerAbilitiesOutgoingPacket;
...
{							
	...
	public GameStatusAwareModule(UserEvaluation userEvaluation)
	{
		...
		this.addConfirmPacket(IChangeGameStateOutgoingPacket.class, this::handleGameStateChange, true);
		...
		this.addIncomingHandlerPre(IEntityActionIncomingPacket.class, this::handleAction);
	...
	{
		if (packet instanceof IChangeGameStateOutgoingPacket)
		{
			return ((IChangeGameStateOutgoingPacket)packet).getState() == IChangeGameStateOutgoingPacket.State.SET_GAMEMODE;
		}
	...
	private void handleGameStateChange(IChangeGameStateOutgoingPacket packet)
	{
		if (packet.getState() == IChangeGameStateOutgoingPacket.State.SET_GAMEMODE) //Game mode change
		{
	...
	private void handleAction(IEntityActionIncomingPacket packet)
	{
