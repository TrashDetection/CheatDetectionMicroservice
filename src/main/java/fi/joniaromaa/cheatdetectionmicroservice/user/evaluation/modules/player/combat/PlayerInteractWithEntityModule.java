...
import fi.joniaromaa.cheatdetectionmicroservice.user.data.IPosition;
...
import fi.joniaromaa.cheatdetectionmicroservice.user.data.PositionMutable;
...
import fi.joniaromaa.cheatdetectionmicroservice.user.evaluation.modules.player.combat.debug.PlayerInteractWithEntityModuleDebug;
import fi.joniaromaa.cheatdetectionmicroservice.user.evaluation.violations.UserViolation;
import fi.joniaromaa.cheatdetectionmicroservice.user.evaluation.violations.player.action.IntaractAtMissingOnPlayerViolation;
...
import fi.joniaromaa.minecrafthook.common.network.outgoing.IDestroyEntitiesOutgoingPacket;
import fi.joniaromaa.minecrafthook.common.network.outgoing.IEntityAttachOutgoingPacket;
import fi.joniaromaa.minecrafthook.common.network.outgoing.IEntityOutgoingPacket;
import fi.joniaromaa.minecrafthook.common.network.outgoing.IEntityTeleportOutgoingPacket;
...
import fi.joniaromaa.minecrafthook.common.network.outgoing.ISpawnPlayerOutgoingPacket;
import fi.joniaromaa.minecrafthook.common.network.outgoing.IUseBedOutgoingPacket;
...
public class PlayerInteractWithEntityModule extends GameStatusAwareSubmodule
{
	...
	{
		if (CheatDetectionService.DEBUG)
		{
