...
import net.goldtreeservers.cheatdetectionmicroservice.utils.OutputStreamUtils;
import net.goldtreeservers.cheatdetectionmicroservice.utils.UserPackets;
import net.goldtreeservers.cheatdetectionmicroservice.utils.UserPacketsNoOp;
...
public abstract class BaseUser
{
	...
	protected BaseUser(int userId, int protocolVersion)
	{
		...
		this.hook = SharedMinecraftHooks.getHook(protocolVersion);
