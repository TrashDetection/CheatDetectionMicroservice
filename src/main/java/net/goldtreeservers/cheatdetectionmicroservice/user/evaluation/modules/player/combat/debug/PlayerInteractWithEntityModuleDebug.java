package net.goldtreeservers.cheatdetectionmicroservice.user.evaluation.modules.player.combat.debug;
...
import fi.joniaromaacheatdetectionmicroserviceminecrafthook.network.incoming.IPluginMessageIncomingPacket.DebugEntityAttack;
import fi.joniaromaacheatdetectionmicroserviceminecrafthook.network.incoming.IPluginMessageIncomingPacket.DebugEntityMove;
...
public class PlayerInteractWithEntityModuleDebug extends PlayerInteractWithEntityModule
{
	...
	public void analyzeIncoming(IMinecraftIncomingPacket packet)
	{
		if (packet instanceof IPluginMessageIncomingPacket)
		{
			...
			if (pluginMessagePacket.getData() instanceof DebugEntityAttack)
			{
				this.debugEntityAttack = (DebugEntityAttack)pluginMessagePacket.getData();
			}
			else if (pluginMessagePacket.getData() instanceof DebugEntityMove)
			{
				DebugEntityMove entityMove = (DebugEntityMove)pluginMessagePacket.getData();
