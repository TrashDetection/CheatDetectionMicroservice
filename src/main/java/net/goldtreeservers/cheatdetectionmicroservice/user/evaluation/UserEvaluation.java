...
import net.goldtreeservers.cheatdetectionmicroservice.user.evaluation.modules.inspect.DebugModule;
import net.goldtreeservers.cheatdetectionmicroservice.user.evaluation.modules.inspect.ForceSaveModule;
import net.goldtreeservers.cheatdetectionmicroservice.user.evaluation.modules.player.action.BlockBreakModule;
import net.goldtreeservers.cheatdetectionmicroservice.user.evaluation.modules.player.action.EntityActionTooFastModule;
import net.goldtreeservers.cheatdetectionmicroservice.user.evaluation.modules.player.action.TooManyInteractsModule;
import net.goldtreeservers.cheatdetectionmicroservice.user.evaluation.modules.player.combat.PlayerAttackNoSwingModule;
import net.goldtreeservers.cheatdetectionmicroservice.user.evaluation.modules.player.combat.PlayerInteractWithEntityModule;
import net.goldtreeservers.cheatdetectionmicroservice.user.evaluation.modules.player.inventory.HeldItemNotChangedModule;
import net.goldtreeservers.cheatdetectionmicroservice.user.evaluation.modules.player.inventory.InvalidContainerTransactionIdModule;
import net.goldtreeservers.cheatdetectionmicroservice.user.evaluation.modules.player.inventory.InvalidInventorySlotChangeModule;
import net.goldtreeservers.cheatdetectionmicroservice.user.evaluation.modules.player.inventory.PlayerInventoryNotOpenModule;
import net.goldtreeservers.cheatdetectionmicroservice.user.evaluation.modules.player.movement.InvalidPlayerLookModule;
import net.goldtreeservers.cheatdetectionmicroservice.user.evaluation.modules.player.movement.NoPositionUpdateModule;
import net.goldtreeservers.cheatdetectionmicroservice.user.evaluation.modules.player.movement.PlayerInterackStatusModule;
import net.goldtreeservers.cheatdetectionmicroservice.user.evaluation.modules.player.movement.PlayerSpeedModule;
import net.goldtreeservers.cheatdetectionmicroservice.user.evaluation.modules.player.movement.SprintSneakingModule;
import net.goldtreeservers.cheatdetectionmicroservice.user.evaluation.modules.player.movement.TooManyMovePacketsModule;
import net.goldtreeservers.cheatdetectionmicroservice.user.evaluation.modules.player.movement.UserNoUpdateModule;
import net.goldtreeservers.cheatdetectionmicroservice.user.evaluation.modules.world.BlockDigNoSwingModule;
import net.goldtreeservers.cheatdetectionmicroservice.user.evaluation.modules.world.BlockPlaceNoSwingModule;
import net.goldtreeservers.cheatdetectionmicroservice.user.evaluation.modules.world.InvalidBlockPositionModule;
