...
import net.goldtreeservers.cheatdetectionmicroservice.user.evaluation.violations.player.inventory.BlockPlaceButFacingEntityViolation;
import net.goldtreeservers.cheatdetectionmicroservice.user.evaluation.violations.player.inventory.JustStoppedBlockingViolation;
import net.goldtreeservers.cheatdetectionmicroservice.user.evaluation.violations.player.inventory.PlayerAttackAfterInteractViolation;
import net.goldtreeservers.cheatdetectionmicroservice.user.evaluation.violations.player.movement.OnBlockingKeptSprintViolation;
...
public class PlayerInterackStatusModule extends GameStatusAwareSubmodule
{
	...
	public void analyzeIncoming(IMinecraftIncomingPacket packet)
	{
		...
		{
			IIncomingEntityActionIncomingPacket entityAction = (IIncomingEntityActionIncomingPacket)packet;
			if (entityAction.getAction() == IIncomingEntityActionIncomingPacket.Action.START_SPRINTING)
			{
				this.sprinting = true;
			}
			else if (entityAction.getAction() == IIncomingEntityActionIncomingPacket.Action.STOP_SPRINTING)
			{
