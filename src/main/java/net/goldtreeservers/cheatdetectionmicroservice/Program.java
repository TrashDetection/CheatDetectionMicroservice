...
import net.goldtreeservers.cheatdetectionmicroservice.user.InspectUser;
...
import net.goldtreeservers.cheatdetectionmicroservice.user.evaluation.modules.player.combat.PlayerInteractWithEntityModule.Entity;
...
public class Program
{
	...
	private static CheatDetectionMicroservice microservice;
	
	public static void main(String[] args) throws Throwable
	{
		Program.LOGGER.info("Loading up...");
		...
		try(Reader reader = Files.newBufferedReader(Paths.get("config.json")))
		{
			...
			config = gson.fromJson(reader, MicroserviceConfig.class);
		}
		
		Program.LOGGER.info("Setting up...");
		
		Program.microservice = new CheatDetectionMicroservice(config);
		Program.microservice.start();
